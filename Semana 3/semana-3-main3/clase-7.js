...
function mostrarDatosEnPerfil() {
    ...
    let albumLength = albumesFamosos.length;

    let spanCantidadAlbumes = document.getElementById('cant-albums');

    spanCantidadAlbumes.textContent = albumLength + (albumLength > 1 ? " albumes" : " album");
    let contador = 0;
    ...
    let spanFavoritos = document.getElementById("cant-favoritos");
    spanFavoritos.textContent = contador + (contador > 1 ? " favoritos" : " favorito");
}
